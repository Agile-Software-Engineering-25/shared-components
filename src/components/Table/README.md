...
import { Table, createTableBuilder, DataItem } from '@agile-software/shared-components';
...
const config = createTableBuilder<User>()
  .addColumn('name', 'Name', { sortable: true, width: '200px' })
  .addColumn('email', 'Email', { sortable: true })
  .addAction({
    key: 'edit',
    label: 'Edit',
  ...
  .enableSorting()
  .enableFiltering()
  .addFilter({ key: 'name', label: 'Name', type: 'text' })
